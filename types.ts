let simpleString: string = "Here is a string";

const areYouReadyForStudy: boolean = true;
...
// Other variable types: undefined, null, unknown & any

console.log(thisIsMessage);
